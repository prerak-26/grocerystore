...
<h2 class="section__title">Customers also purchased</h2>
    <div class="gallery__container container grid">
            <?php
                        $sql = "SELECT * FROM `offer_list` WHERE offer_id = '" . mysqli_escape_string($conn,1) . "'"; 
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            <form action="offers.php" method="post">
                                ...
                                <div class="gallery__button">
                                     <a href="cart.php?offerid=1"><i class="ri-shopping-cart-2-line gallery_addcart"> add cart</i></a>
                                </div>
